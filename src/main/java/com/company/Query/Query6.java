...
public class Query6 {
   ...
   public static void main(String[] args) {
	   ...
	   try{
	      ...
	      // Add new title
	      String query6Title = "INSERT INTO Titles ( title, editionNumber, year, publisherID, price)" +
	      				       "VALUES ( 'Artemis: A Novel', '1', '2017', (SELECT publisherID FROM Publishers WHERE publisherName = 'Crown'), '16.20')";
	      ...
	      String query6authorISBN = "INSERT INTO authorISBN (authorID, isbn)" +
	      				       "VALUES ((SELECT authorID FROM Authors WHERE firstName = 'Jack' AND lastName = 'London'), '055')";
          ...
          while (rs2.next()) {
           // String isbn = rs2.getString("isbn");
            ...
            System.out.println(title + "\t" + edition + "\t" + year + "\t" + pubID + "\t" + price);
          }
